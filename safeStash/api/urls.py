...
urlpatterns = [
    ...
    path('edit/members', views.edit_aikyam_members, name="api"),
    path('delete/members', views.delete_aikyam_members, name="api"),
    ...
    path('edit/<int:id>/', views.show_selected_user, name='api'),
